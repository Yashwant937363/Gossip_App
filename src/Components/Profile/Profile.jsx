    ...
    <div className="profilepage">
      <form className="profileform">
        ...
        <div className="firstlastname">
          ...
          <button onClick={fullnameToggle} type="button" className="editbutton">
            <Pencil></Pencil>
          </button>
        </div>
        <div
        ...
        >
          ...
          <button onClick={usernameToggle} type="button" className="editbutton">
            <Pencil></Pencil>
          </button>
        </div>
        <div
        ...
        >
          ...
          <button onClick={emailToggle} type="button" className="editbutton">
            <Pencil></Pencil>
          </button>
        </div>
        ...
        <div className="withicon dob">
          {dobtoggle ? (
            ...
            <span className="dobtext">
              {dob.toLocaleDateString("en-US", { month: "short" })}{" "}
              {dob.getDate()},{dob.getFullYear()}
            </span>
          )}
          <button onClick={dobToggle} type="button" className="editbutton">
            <Pencil></Pencil>
          </button>
        </div>
        <div className="inputtitle">UID : </div>
        <div className="withicon">{uid}</div>
